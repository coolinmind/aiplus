<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/orders/edit.html";i:1489975221;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1492571762;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="mws-panel grid_4">
            ...
            <div class="mws-panel-body no-padding">
                <form class="mws-form" action="/admin/orders/update" method="post">
                    <div class="mws-form-inline">
                       <div class="mws-form-row bordered">
                            <label class="mws-form-label">ID号：</label>
                        ...
                        <div class="mws-form-row bordered">
                            ...
                            <div class="mws-form-item">
                                <input type="text" value="<?php echo $res['order_num']; ?>" class="large" name='order_num'>
                            </div>
                        </div>
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">订单标题：</label>
                            <div class="mws-form-item">
                                <input type="text" value="<?php echo $res['title']; ?>" class="large" name='title'>
                            </div>
                        </div>
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">角色状态：</label>
                            <div class="mws-form-item">
                                <select name="role_status" class="large">
									<?php if($res['role_status'] == 0): ?>
                                        <option value="0">匹配中</option>
                                        <option value="1">发起合同</option>
                                        <option value="2">筛选中</option>
                        ...
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">订单生成时间：</label>
                            <div class="mws-form-item">
                                <input type="text" value="<?php echo $res['add_time']; ?>" class="large" name='add_time'>
                            </div>
                        </div>
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">订单价格：</label>
                            <div class="mws-form-item">
                                <input type="text" value="<?php echo $res['order_price']; ?>" class="large" name='order_price'>
                            </div>
                        </div>
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">任务ID：</label>
                            <div class="mws-form-item">
                                <input type="text" value="<?php echo $res['task_id']; ?>" class="large" name='task_id'>
                            </div>
                        </div>
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">技能ID：</label>
                            <div class="mws-form-item">
                                <input type="text" value="<?php echo $res['skill_id']; ?>" class="large" name='skill_id'>
                            </div>
                        </div>
