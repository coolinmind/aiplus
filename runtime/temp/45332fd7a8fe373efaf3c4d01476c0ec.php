<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:93:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/authentication/index.html";i:1490586935;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493201256;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
	...
	<div class="container">
		<div class="mws-panel grid_8">
			<div class="mws-panel-header">
		    	<span><i class="icon-table"></i> 个人身份认证列表</span>
		    </div>
		            ...
		            <tbody align='center'>
		                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
		                	<tr>
			                    ...
			                    <td style="word-break:break-all"><img src="<?php echo $v['up_photo']; ?>" alt="" width="100px"></td>
			                    <td style="word-break:break-all"><img src="<?php echo $v['back_photo']; ?>" alt="" width="100px"></td>
			                    <?php if($v['status'] == 0): ?>
			                    	<td style="word-break:break-all">审核中</td>
			                    <?php elseif($v['status'] == 1): ?>
			                    	<td style="word-break:break-all">审核完成</td>
			                    <?php endif; ?>
			                    <td style="word-break:break-all"><?php echo $v['remarks']; ?></td>
			                    <td>
			                    	<span class="btn-group">
	                                    <a href="/admin/authentication/edit?id=<?php echo $v['id']; ?>" class="btn btn-small">
