<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/password/edit.html";i:1489467567;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493201256;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
...
<div id="mws-container" class="clearfix">
	...
	<div class="mws-panel grid_4">
	    ...
	    <div class="mws-panel-body no-padding">
	    	<form class="mws-form" action="/admin/password" method="post">
	    		...
	    		<div class="mws-form-block">
	    			<div class="mws-form-row">
	    				...
	    				<div class="mws-form-item">
	    					<input type="text" class="error large" name="oldpass">
	                        <div class="mws-error">
	                        	必填
	                        </div>
	    				</div>
	    				...
	    				<div class="mws-form-item">
	    					<input type="text" class="error large" name="newpass">
	                        <div class="mws-error">
	                        	必填
	                        </div>
	    				</div>
	    				...
	    				<div class="mws-form-item">
	    					<input type="text" class="error large" name="surepass">
	                        <div class="mws-error">
	                        	必填
	                        </div>
	    				</div>
