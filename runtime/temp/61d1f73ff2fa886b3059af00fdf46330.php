<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/detail/index.html";i:1489467510;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493201256;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container">
    	<div class="mws-panel grid_6">
                	<div class="mws-panel-header">
                    	<span><i class="icon-ok"></i> 个人资料</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                    	<form id="mws-validate" class="mws-form" action="/admin/upload" method="post" enctype="multipart/form-data">
                        	<div id="mws-validate-error" class="mws-form-message error" style="display:none;"></div>
                        	<div class="mws-form-inline">
                            	<div class="mws-form-row">
                                	<label class="mws-form-label">用户名</label>
                                	<div class="mws-form-item">
                                    	<input style="width:300px;" disabled type="text" name="reqField" class="required large" value="<?php echo $info['name']; ?>">
                                    </div>
                                </div>
                            	<div class="mws-form-row">
                                	<label class="mws-form-label">用户头像</label>
                                	<div class="mws-form-item">
                                    	<img width="100" src="<?php if($info['photo']): ?><?php echo $info['photo']; else: ?>/Backstage/example/profile.jpg<?php endif; ?>" alt="User Photo">
                                    </div>
                                </div>
                                <?php if(\think\Session::get('error')): ?>
                                <div style="border:0px;" class="mws-panel-body no-padding">
                                    <div class="mws-form-message error">
                                        <?php echo \think\Session::get('error'); ?>
                                    </div>
                                </div>
                                <?php endif; ?>
                            	<div class="mws-form-row">
                                	<label class="mws-form-label">选择头像</label>
                                	<div style="width:300px;" class="mws-form-item">
