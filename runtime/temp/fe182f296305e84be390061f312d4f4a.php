<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/skill/index.html";i:1492585069;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493201256;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
	...
	<div class="container" >
		<div class="mws-panel ">
			<div class="mws-panel-header">
		    	<span><i class="icon-table"></i>技能列表</span>
		    </div>
		    <div class="dataTables_wrapper" id="DataTables_Table_0_wrapper" role="grid"> 
		        <table class="mws-datatable mws-table" >
		        <?php if(\think\Session::get('success')): ?>
		            <div class="mws-form-message success">
                    	恭喜
                        <ol>
                        	<li><?php echo \think\Session::get('success'); ?></li>
                        </ol>
                    </div>
				<?php endif; ?>
		            <thead>
		            ...
		            <tbody align='center'>
		            	<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
			                <tr>
			                    ...
			                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['uid']; ?></td>
			                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['address']; ?></td>
			                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['skill_type']; ?></td>
			                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['skill_name']; ?></td>
			                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['skillType']; ?></td>
			                    <td>
			                    	<span class="btn-group">
	                                    <a href="/admin/skill/edit?id=<?php echo $v['id']; ?>" class="btn btn-small"><i class="icon-pencil"></i></a>
	                                    <a href="/admin/skill/delete?id=<?php echo $v['id']; ?>" onclick="return confirm('确定要删除这个技能么?');" class="btn btn-small"><i class="icon-trash"></i></a>
	                                </span>
	                            </td>
		               		</tr>
