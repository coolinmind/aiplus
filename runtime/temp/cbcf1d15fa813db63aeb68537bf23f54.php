<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/employ/index.html";i:1495439970;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1495437469;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1495437469;}*/ ?>
<!DOCTYPE html>
	...
	<div class="container" >
		<div class="mws-panel ">
			<div class="mws-panel-header">
		    	<span><i class="icon-table"></i>需求列表</span>
		    </div>
		    <div class="mws-panel-body no-padding" >
                <form class="mws-form" action="form_layouts.html">
                    <?php if(\think\Session::get('tis1') == 1): ?>
                        <div class="mws-form-message success">
                            操作成功 点击消失
                        </div>
                    <?php elseif(\think\Session::get('tis1') == 2): ?>
		    ...
		    <div class="mws-panel-body no-padding" > 
		        <table class="mws-datatable mws-table" >
		            ...
		            <tbody align='center'>
		            	<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($v['is_delete'] == 0): ?>
				                <tr>
				                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['id']; ?></td>
				                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['employ_id']; ?></td>
				                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['worker_id']; ?></td>
				                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['title']; ?></td>
				                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['task_time']; ?></td>
				                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['address']; ?></td>
				                    <?php if($v['type'] == 0): ?>
				                    	<td>单独用人</td>
				                    <?php elseif($v['type'] == 1): ?>
				                    	<td>项目用人</td>
			                    	<?php endif; ?>
				                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['task_tags']; ?></td>
				                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['task_price']; ?></td>
				                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['method']; ?></td>
				                    <td style=' word-wrap:break-word; word-break:break-all; overflow: hidden;'><?php echo $v['task_type']; ?></td>
				                    <td>
				                    	<span class="btn-group">
		                                    <a href="/admin/employ/edit?id=<?php echo $v['id']; ?>" class="btn btn-small"><i class="icon-pencil"></i></a>
		                                    <a href="/admin/employ/del?id=<?php echo $v['id']; ?>" onclick="return confirm('确定要删除这个需求么?');" class="btn btn-small"><i class="icon-trash"></i></a>
		                                </span></td>
			               		</tr>
