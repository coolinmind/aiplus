<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/authentication/edit.html";i:1490344153;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493085435;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="mws-panel grid_4">
            ...
            <div class="mws-panel-body no-padding">
                <form class="mws-form" action="/admin/authentication/update" method="post">
                    <div class="mws-form-inline">
                       <div class="mws-form-row bordered">
                            <label class="mws-form-label">I D 号：</label>
                        ...
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">认证姓名：</label>
                            <div class="mws-form-item">
                                <span><?php echo $res['name']; ?></span>
                            </div>
                        </div>
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">身份证号码：</label>
                            <div class="mws-form-item">
                                <span><?php echo $res['id_number']; ?></span>
                            </div>
                        </div>
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">认证照片正面：</label>
                            <div class="mws-form-item">
                                <!-- <span><?php echo $res['up_photo']; ?></span> -->
                                <img src="<?php echo $res['up_photo']; ?>" width="150px">
                            </div>
                        </div>
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">认证照片反面：</label>
                            <div class="mws-form-item">
                                <!-- <span><?php echo $res['back_photo']; ?></span> -->
                                <img src="<?php echo $res['back_photo']; ?>" width="150px">
                            </div>
                        </div>
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">审核状态：</label>
                            <div class="mws-form-item">
                                <select name="status" id="" class="large">
                                    <?php if($res['status'] == 0): ?>
                        ...
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">备注信息：</label>
                            <div class="mws-form-item">
                                <textarea name="remarks" cols="45" rows="10"><?php echo $res['remarks']; ?></textarea>
                            </div>
                        </div>
