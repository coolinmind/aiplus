<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/userlist/insert.html";i:1492236519;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493201256;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
    	...
    	<div class="mws-panel grid_8">
            ...
            <div class="mws-panel-body no-padding">
            	<form id="form" action="/admin/userlist/insert" method="post" enctype="multipart/form-data">
            		<?php if(\think\Session::get('info')): ?>
	            		<div class="mws-form-message error">
	                    	添加失败
	                        <ul>
	                        	<?php if(is_array(\think\Session::get('info')) || \think\Session::get('info') instanceof \think\Collection || \think\Session::get('info') instanceof \think\Paginator): $i = 0; $__LIST__ = \think\Session::get('info');if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
								<li><?php echo $vo; ?></li>
	                ...
	                <table class="mws-table">
	                    ...
	                    <tbody id="tbody" align="center">
	                    	<?php if(\think\Session::get('str')): ?>
	                    	<?php echo \think\Session::get('str'); ?>
