<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/menu/list.html";i:1489467533;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1492588117;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
...
<div id="mws-container" class="clearfix">
    <div class="container">
    	<div class="mws-panel grid_7" style='margin-left: 80px'>
	    	<div class="mws-panel-header">
	        	<span><i class="icon-table"></i>编辑</span>
	        </div>
	        <div class="mws-panel-body no-padding">
	            <table class="mws-table">
	                ...
	                <form class="mws-form" method="post" action="/admin/menu/setedit">
		                <tbody align='center'>
			                        ...
			                        <td>
										<div class="mws-form-col-1-8">
					                        ...
					                        <div class="mws-form-item">
					                        	<input type="hidden" name='data[<?php echo $v['id']; ?>][id]' value='<?php echo $v['id']; ?>'>
					                            <input type="text" name='data[<?php echo $v['id']; ?>][menu_name]' value='<?php echo $v['menu_name']; ?>'>
					                        </div>
					                    </div>
			                        </td>
			                        <td>
				                        <div class="mws-form-col-1-8">
					                        <label class="mws-form-label"></label>
					                        <div class="mws-form-item">
					                            <input type="text" name='data[<?php echo $v['id']; ?>][menu_path]' value='<?php echo $v['menu_path']; ?>'>
					                        </div>
					                    </div>
					                </td>
			                        <td>
										<div class="mws-form-col-1-8">
					                        <label class="mws-form-label"></label>
					                        <div class="mws-form-item">
					                            <select class="large" name='data[<?php echo $v['id']; ?>][is_show]'>
					                            	<?php if($v['is_show'] == 1): ?>
