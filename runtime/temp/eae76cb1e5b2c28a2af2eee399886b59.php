<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:97:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/category/category_review.html";i:1490681233;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1492588117;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span><i class="icon-table"></i>技能类型待审表</span>
            </div>
            ...
            <form action="/admin/category/check" method="post">
                <div class="mws-panel-body no-padding">
                    <table class="mws-datatable mws-table">
                        <thead>
                            <!-- <tr>
                                <td rowspan="1" colspan="10">
                                    <input type="submit" id="mws-jui-dialog-mdl-btn" class="btn btn-primary bkform" value=" 提交多选 ">
                                </td>
                            </tr> -->
                            <tr>
                                <!-- <th width="50px">多选：</th> -->
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="btn-group">
                                                <a class="btn btn-small btns1" onclick="return confirm('点击确定会删除掉当前选项并将(<?php echo $v['name']; ?>)添加到技能类型表么？');" href="/admin/category_review/submit?id=<?php echo $v['id']; ?>">
                                                    <i class="icon-edit"></i>
                                                </a>
                                        </span>
                                    </td>
