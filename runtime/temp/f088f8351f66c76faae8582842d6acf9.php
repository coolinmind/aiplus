<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/admin/admin.html";i:1489467488;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493201256;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8 mws-collapsible">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>管理员管理</span>
                    </div>
                    ...
                    <div class="mws-panel-body no-padding">
                        <table class="mws-table mws-datatable" >
                            <thead>
                                 <tr>
                                    <td><input type="button" id="mws-jui-dialog-mdl-btn" class="btn btn-primary bkform" value="  添加管理员  "></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="btn-group">
                                                <a href="/admin/adminuppage?id=<?php echo $v['id']; ?>" class="btn btn-small" ><i class="icon-pencil"></i></a>
                                                <a href="/admin/admindel?id=<?php echo $v['id']; ?>" onclick="return confirm('确定要删除<?php echo $v['name']; ?>管理员么?');" class="btn btn-small"><i class="icon-trash"></i></a>
                                            </span>
                                        </td>
                                    </tr>
                   ...
                   <div class="mws-panel grid_4" id='dis' style="display: none;z-index: 99999;position:absolute;left:260px;top:150px">
                    <div class="mws-panel-header">
                        <span>管理员添加</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="/admin/adminadd" method="post">
                               ...
                               <div class="mws-form-row bordered">
                                    ...
                                    <div class="mws-form-item">
                                        <select class="large" name='rid'>
                                            <?php if(is_array($row) || $row instanceof \think\Collection || $row instanceof \think\Paginator): $i = 0; $__LIST__ = $row;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
...
$('.bkform').click(function(){
    // $('#mws-wrapper').css({'background':'#666','z-index':'222','filter':'alpha(Opacity=80)','-moz-opacity':'0.5','opacity': '0.5'});
