<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/role/permissions.html";i:1489484226;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493085435;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container">
		<div class="mws-panel grid_8">
                    ...
                    <div class="mws-panel-body no-padding">
                    	<form class="mws-form" action="/admin/role/permissionwrite" method="post">
                    		<div class="mws-form-inline">
                    			<div class="mws-form-row">
                                    <?php if(is_array($item) || $item instanceof \think\Collection || $item instanceof \think\Paginator): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if(($v['parent_id'] == 0) and ($v['is_show'] == 1)): ?>
                            				<label class="mws-form-label"><?php echo $v['menu_name']; ?></label>
                                                <br>
                                                <div class="mws-form-item clearfix">
                                                        <ul class="mws-form-list inline">
                                                        <?php if(is_array($item) || $item instanceof \think\Collection || $item instanceof \think\Paginator): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v1): $mod = ($i % 2 );++$i;if($v1['parent_id'] == $v['id']): if($v1['is_show'] == 1): if(isset($res)): ?> 
                                                                   		   <li><input type="checkbox" name="data[]" value="<?php echo $v1['id']; ?>" <?php if(in_array(($v1['id']), is_array($res)?$res:explode(',',$res))): ?> checked="checked" <?php endif; ?>>  <label><?php echo $v1['menu_name']; ?></label></li>
                                                                        <?php else: ?>
                                                                            <li><input type="checkbox" name="data[]" value="<?php echo $v1['id']; ?>">  <label><?php echo $v1['menu_name']; ?></label></li>
                    		...
                    		<div class="mws-button-row">
                    			...
                    			<input type="submit" value="确定授权" class="btn btn-danger">
