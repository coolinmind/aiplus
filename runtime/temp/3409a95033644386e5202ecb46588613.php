<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/index/index.html";i:1495439971;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1495437469;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1495437469;}*/ ?>
<!DOCTYPE html>
...
<div class="mws-panel grid_8">
    <div class="mws-panel-header">
        <span><i class="icon-table"></i> 欢迎您：<?php echo \think\Session::get('admin.name'); ?>!</span>
        <span style="float: right;margin-top: -24px;">当前时间：<font id="time"></font></span>
    </div>
    <div class="mws-panel-body no-padding">
        <table class="mws-table">
            <thead>
                <tr>
                    <th colspan="2">您的相关信息</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                ...
                <tr>
                    <td>登录次数：</td>
                    <td><?php echo \think\Session::get('admin.times'); ?></td>
                </tr>
                <tr>
                    <td>ip地址：</td>
                    <td><?php echo $ip; ?></td>
