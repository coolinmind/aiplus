<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/accounts/index.html";i:1489994566;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493201256;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span><i class="icon-table"></i>卡号管理</span>
            </div>
                    ...
                    <tbody align="center">
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td style="word-break:break-all"><?php echo $v['wallet_id']; ?></td>
                                <td style="word-break:break-all"><?php echo $v['type']; ?></td>
                                <td style="word-break:break-all"><?php echo $v['institution']; ?></td>
                                <td style="word-break:break-all"><?php echo $v['name']; ?></td>
                                <td style="word-break:break-all"><?php echo $v['num']; ?></td>
                                <td style="word-break:break-all"><?php echo $v['account']; ?></td>
                                ...
                                <td>
                                    <span class="btn-group">
                                            <a class="btn btn-small btns1"  href="/admin/accounts/edit?id=<?php echo $v['id']; ?>">
                                                <i class="icon-edit"></i>
                                            </a>
                                    </span>
                                </td>
