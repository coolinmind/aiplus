<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/category/category.html";i:1489917679;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1492588117;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span><i class="icon-table"></i>技能类型列表</span>
            </div>
                    ...
                    <tbody align="center">
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                            <tr>
                                ...
                                <td style='width:260px'><?php echo $v['general']; ?></td>
                                <td style='width:260px'><?php echo $v['experience']; ?></td>
                                <td style='width:260px'><?php echo $v['certificate']; ?></td>
                                <td>
                                    <span class="btn-group">
                                            <a class="btn btn-small btns1" href="/admin/category/edit?id=<?php echo $v['id']; ?>">
