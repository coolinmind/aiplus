<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/userinfo/index.html";i:1495439977;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1495437469;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1495437469;}*/ ?>
<!DOCTYPE html>
	...
	<div class="container">
		<div class="mws-panel grid_8">
                	...
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>用户信息</span>
                    </div>
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="form_layouts.html">
                            ...
                            <?php elseif(\think\Session::get('tishis') == 2): ?>
                            ...
                            <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        		<tr class="odd">
                                    ...
                                    <?php elseif($v['sex'] == 2): ?>
                                        <td>保密</td>
                                    <?php endif; ?>
                                    <td><img src="<?php echo $v['icon']; ?>" width="50px"></td>
                                    <?php if($v['Verify'] == 0): ?>
                                        <td>未认证</td>
                                    <?php elseif($v['Verify'] == 1): ?>
                                        <td>已认证</td>
                                    <?php endif; ?>
                                    ...
                                    <?php endif; ?>
                                   	<td >
                                        <span class="btn-group">
                                            <a class="btn btn-small btns1" href="/admin/userinfo/edit?id=<?php echo $v['id']; ?>"><i class="icon-pencil"></i></a>
                                   		</span>
                                    </td>
                                 </tr>
