<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:92:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/userlist/userupdate.html";i:1489467613;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1490769179;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1490859504;}*/ ?>
<!DOCTYPE html>
	...
	<div class="container">
		<div class="mws-panel grid_8">
        	...
        	<div class="mws-panel-header">
            	...
            	<span><i class="icon-ok"></i>　<a href="/admin/userlist">用户列表</a><i class="icon-chevron-right"></i>用户修改</span>
            </div>
            <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="form_layouts.html">
                            <?php if(\think\Session::get('tishis') == 1): ?>
            ...
            <div class="mws-panel-body no-padding">
            	...
            	<form id="mws-validate" class="mws-form" action="/admin/userupdate" method='post'>
                	<div id="mws-validate-error" class="mws-form-message error" style="display:none;"></div>
                	<div class="mws-form-inline">
                    	<div class="mws-form-row">
                        	<label class="mws-form-label">I D ：</label>
                        	<div class="mws-form-item">
                            	<input type="text" name="id" class="required large" disabled='disabled' value="<?php echo $info['0']['id']; ?>">
                            </div>
                        </div>
                    	<div class="mws-form-row">
                        	<label class="mws-form-label">用户名：</label>
                        	<div class="mws-form-item">
                            	<input type="text" name="username" class="required email large" disabled='disabled' value="<?php echo $info['0']['username']; ?>">
                            </div>
                        </div>
                    	<div class="mws-form-row">
                        	<label class="mws-form-label">邮箱号：</label>
                        	<div class="mws-form-item">
                            	<input type="text" name="email" class="required url large" disabled='disabled' value="<?php echo $info['0']['email']; ?>">
                            </div>
                        </div>
                        <?php if($info['0']['delstatus'] == 1): ?>
                        	<div class="mws-form-row">
                            	<label class="mws-form-label">封禁状态：</label>
                            	<div class="mws-form-item">
                            		<select class="required large" name="delname" >	    
                        ...
                        <?php else: ?>
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item">
                                    <select class="required large" name="delname">                                
                                            <option value='0'  selected = "selected" >被封</option>
                            ...
                            <div class="mws-form-row">
                            	<label class="mws-form-label">封禁时间：</label>
                            	<div class="mws-form-item">
                                	<input type="text" class="required digits large" disabled='disabled' value="<?php echo $info['0']['deltime']; ?>">
                                </div>
                            </div>
                    ...
                    <div class="mws-button-row">
                        <input type="hidden" name='username' value="<?php echo $info['0']['username']; ?>">
