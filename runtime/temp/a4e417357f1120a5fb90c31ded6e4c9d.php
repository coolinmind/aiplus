<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/task_type/edit.html";i:1489916354;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1492588117;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="mws-panel grid_4">
            ...
            <div class="mws-panel-body no-padding">
                <form class="mws-form" action="/admin/task_type/update" method="post">
                    <div class="mws-form-inline">
                       <div class="mws-form-row bordered">
                        ...
                        <div class="mws-form-row bordered">
                            <label class="mws-form-label">任务类型名称：</label>
                            <div class="mws-form-item">
                                <input type="text" class="large" value="<?php echo $data['select']; ?>" name='select'>
                            </div>
                        </div>
