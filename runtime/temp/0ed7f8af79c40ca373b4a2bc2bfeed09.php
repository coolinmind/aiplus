<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:90:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/agreement/details.html";i:1492425881;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1492483391;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1490859504;}*/ ?>
<!DOCTYPE html>
...
<div class="mws-panel grid_8">
    ...
    <div class="mws-panel-body no-padding">
    	<form class="mws-form" action="/admin/agreement/details" method="post">
    		<input type="hidden" name="id" value="<?php echo $data['id']; ?>">
            <div class="mws-form-row">
            	<div class="mws-form-cols">
                    <div class="mws-form-col-1-8">
                        <label class="mws-form-label">合同标题</label>
                        <div class="mws-form-item">
                            <input type="text" name="title" value="<?php echo $data['title']; ?>">
                        </div>
                    </div>
                    <div class="mws-form-col-1-8">
                        <label class="mws-form-label">甲方姓名</label>
                        <div class="mws-form-item">
                            <input name="first_party" type="text" value="<?php echo $data['first_party']; ?>">
                        </div>
                    </div>
                    <div class="mws-form-col-1-8">
                        <label class="mws-form-label">乙方姓名</label>
                        <div class="mws-form-item">
                            <input name="second_party" type="text" value="<?php echo $data['second_party']; ?>">
                        </div>
                    </div>
                    <div class="mws-form-col-1-8">
                        <label class="mws-form-label">任务类型</label>
                        <div class="mws-form-item">
                            <input name="mission_type" type="text" value="<?php echo $data['mission_type']; ?>">
                        </div>
                    </div>
                    <div class="mws-form-col-1-8">
                    ...
                    <div class="mws-form-col-1-8">
                        <label class="mws-form-label">甲方身份证号</label>
                        <div class="mws-form-item">
                            <input name="first_idnumber" type="text" value="<?php echo $data['first_idnumber']; ?>">
                        </div>
                    </div>
                    <div class="mws-form-col-1-8">
                        <label class="mws-form-label">乙方身份证号</label>
                        <div class="mws-form-item">
                            <input name="second_idnumber" type="text" value="<?php echo $data['second_idnumber']; ?>">
                        </div>
                    </div>
                    <div class="mws-form-col-1-8">
                        <label class="mws-form-label">合同时间</label>
                        <div class="mws-form-item">
                            <input name="add_time" type="text" disabled value="<?php echo $data['add_time']; ?>">
                        </div>
                    </div>
                </div>
            </div>
            <div class="mws-form-row">
                <div class="mws-form-cols">
                    <div class="mws-form-col-1-8">
                        <label class="mws-form-label">开始时间</label>
                        <div class="mws-form-item">
                            <input name="begin_time" type="text" value="<?php echo $data['begin_time']; ?>">
                        </div>
                    </div>
                    <div class="mws-form-col-1-8">
                        <label class="mws-form-label">结束时间</label>
                        <div class="mws-form-item">
                            <input name="end_time" type="text" value="<?php echo $data['end_time']; ?>">
                        </div>
                    </div>
                    <div class="mws-form-col-1-8">
                        <label class="mws-form-label">合同价格</label>
                        <div class="mws-form-item">
                            <input name="agreement_price" type="text" value="<?php echo $data['agreement_price']; ?>元">
                        </div>
                    </div>
                </div>
            </div>
            <div class="mws-form-row">
                <div class="mws-form-cols">
                    <div class="mws-form-col-4-8">
                        <label class="mws-form-label">甲方签名</label>
                        <div class="mws-form-item">
                            <?php if($data['first_signature']): ?>
							<img src="<?php echo $data['first_signature']; ?>">
							<?php else: endif; ?>
                        </div>
                    </div>
                    <div class="mws-form-col-4-8">
                        <label class="mws-form-label">乙方签名</label>
                        <div class="mws-form-item">
                        	<?php if($data['second_signature']): ?>
							<img src="<?php echo $data['second_signature']; ?>">
							<?php else: endif; ?>
                        </div>
                    </div>
                </div>
    		...
    		<div class="mws-button-row">
    			...
    			<input id="button" type="button" value="返回" class="btn ">
    		</div>
        </form>
    </div>
</div>
