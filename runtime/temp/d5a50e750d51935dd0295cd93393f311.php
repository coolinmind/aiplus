<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:95:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/WalletDetails/accounts.html";i:1492155321;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493201256;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="container">
        <div class="mws-panel grid_8">
            <div class="mws-panel-header">
                <span><i class="icon-table"></i>交易明细</span>
            </div>
            ...
            <div class="mws-panel-body no-padding">
                <table class="mws-datatable mws-table">
                    ...
                    <tbody align="center">
                        <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;if($v['type'] == 1): ?>
                                <tr>
                                    <td style="word-break:break-all"><?php echo $v['id']; ?></td>
                                    <td style="word-break:break-all"><?php echo $v['uid']; ?></td>
                                    <td style="word-break:break-all"><?php echo $v['account_id']; ?></td>
                                    <td style="word-break:break-all"><?php echo $v['transaction_account']; ?></td>
                                    <td style="word-break:break-all"><?php echo $v['balance']; ?></td>
                                    <td style="word-break:break-all"><?php echo $v['transaction_time']; ?></td>
                                    <?php if($v['type'] == 1): ?>
                                        <td>提现</td>
                                    <?php endif; ?>
                                    ...
                                    <td><a class="btn btn-small btns" href="/admin/WalletDetails/pay?id=<?php echo $v['id']; ?>"><i class="icon-ok"></i></a></td>
                                </tr>
