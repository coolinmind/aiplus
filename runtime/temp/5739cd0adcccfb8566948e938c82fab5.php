<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/role/role.html";i:1489467589;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/header.html";i:1493201256;s:79:"/data/wwwroot/dev.happyoneplus.com/public/../application/admin/view/footer.html";i:1492573186;}*/ ?>
<!DOCTYPE html>
            ...
            <div class="container">
                ...
                <div class="mws-panel grid_8 mws-collapsible" style="position:relative">
                	<div class="mws-panel-header">
                    	<span><i class="icon-table"></i>角色管理</span>
                    </div>
                    ...
                    <div class="mws-panel-body no-padding">
                        ...
                        <table class="mws-table mws-datatable" >
                            <thead>
                                <tr>
                                    <td><input type="button" id="mws-jui-dialog-mdl-btn" class="btn btn-primary bkform" value="  添加角色  "></td>
                                    <td></td>
                                    <td></td>
                                </tr>
                                <tr>
                            ...
                            <tbody align='center'>
                               <?php if(is_array($res) || $res instanceof \think\Collection || $res instanceof \think\Paginator): $i = 0; $__LIST__ = $res;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($v['names'] == '超级管理员'): ?>
                                                <span>不能操作</span>
                                            <?php else: ?>
                                                <span class="btn-group">
                                                    <a href="/admin/role/permissions?id=<?php echo $v['id']; ?>" class="btn btn-small"><i class="icon-pencil"></i></a>
                                                    <a href="/admin/roledel?id=<?php echo $v['id']; ?>" onclick="return confirm('确定删除<?php echo $v['names']; ?>角色么?');" class="btn btn-small"><i class="icon-trash"></i></a>
                                                </span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                ...
                <div class="mws-panel grid_4" id='dis' style="display: none;z-index: 99999;position:absolute;left:260px;top:150px">
                    ...
                    <div class="mws-panel-body no-padding">
                        <form class="mws-form" action="/admin/roleadd" method="post">
